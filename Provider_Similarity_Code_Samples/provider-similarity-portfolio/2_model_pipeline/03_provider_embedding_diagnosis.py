...
# ============================================================================
PIN_A = 100000001  # placeholder provider id  # Provider A PIN
PIN_B = 100000002  # placeholder provider id   # Provider B PIN  
PIN_C = 100000003  # placeholder provider id    # Provider C PIN
# ============================================================================
...
if not os.path.exists('data13.npz'):
    ...
    print("save_npz('data13.npz', cooccurrence_matrix)")
    cooccurrence_matrix = None
else:
    cooccurrence_matrix = load_npz('data13.npz')
...
# Save results
output_filename = f"data18_{PIN_A}_{PIN_B}_{PIN_C}.csv"
