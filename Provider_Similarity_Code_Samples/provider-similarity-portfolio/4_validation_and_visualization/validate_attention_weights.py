...
# ============================================================================
PIN_A = 100000001  # placeholder provider id
PIN_B = 100000002  # placeholder provider id  
PIN_C = 100000003  # placeholder provider id
# ============================================================================
...
if A_attention is not None:
    ...
    import json
    with open(f'data25_{PIN_A}_{PIN_B}_{PIN_C}.json', 'w') as f:
...
pd.DataFrame([summary]).to_csv(f'data24_{PIN_A}_{PIN_B}_{PIN_C}.csv', index=False)
